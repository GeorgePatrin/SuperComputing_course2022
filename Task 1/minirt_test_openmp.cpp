...
int main(int argc, char **argv) {
    int viewPlaneResolutionX = (argc > 1 ? std::stoi(argv[1]) : 2500);////
    int viewPlaneResolutionY = (argc > 2 ? std::stoi(argv[2]) : 2500);////
    ...
    #pragma omp parallel for num_threads(16) schedule(dynamic) collapse(2)// static, runtime, guided, dynamic
